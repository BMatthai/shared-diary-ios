...
//        UserManager.shared.getUserList()
        ...
        Auth.auth().addStateDidChangeListener { auth, user in
            if let user = user {
                ...
                NotificationCenter.default.post(name: Notification.Name("SuccessfulSignOutNotification"), object: nil, userInfo: nil)
                UserManager.shared.updateRootVC()
    ...
    func sign(_ signIn: GIDSignIn!, didSignInFor user: GIDGoogleUser!, withError error: Error?) {
        ...
        UserManager.shared.signIn(credential: credential)
